...
function App() {
  ...
  return (
    <>
     <div className='scale-[1.1] absolute left-1/2 top-1/2 translate-x-[-50%] translate-y-[-50%] w-[40vw]  h-[25vw] shadow-md rounded-lg px-4 py-8 text-orange-500 bg-gray-900 '>
     <h1 className='text-white text-center mb-4 text-4xl'>Password Generator</h1>
      ...
      <div className="mt-10 gap-x-3 scale-[1] lg:scale-[2] flex items-center justify-center  ">
          <input type="range" min={6} max={100} value={length} onChange={(e) => {setlength(e.target.value)}} className='cursor-pointer'/>
          <label>Length : {length}</label>
      </div>
      <div className="mt-5 flex items-center justify-center text-xl gap-x-20 lg:text-3xl sm:text-3xl xl:text-4xl">    
